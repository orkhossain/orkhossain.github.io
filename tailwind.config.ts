  ...
  theme: {
    ...
    extend: {
      fontFamily: {
        ...
        'elegant': ['Playfair Display', 'Times New Roman', 'Times', 'serif'],
      },
      colors: {
        ...
        "gallery-text": "hsl(var(--gallery-text))",
        "gallery-text-muted": "hsl(var(--gallery-text-muted))",
        sidebar: {
      ...
      animation: {
        ...
        "gallery-reveal": "gallery-reveal 1s cubic-bezier(0.16, 1, 0.3, 1)",
